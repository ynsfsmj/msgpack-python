...
/*
 * diy : Tuple 0x00 [array]
 */
static inline int msgpack_pack_tuple(msgpack_packer* x, unsigned int n)
{
    unsigned char diy[2];
    diy[0] = 0xc1;
    diy[1] = 0x00;
 ...
 * diy : Set 0x01 [array]
 */
static inline int msgpack_pack_set(msgpack_packer* x, unsigned int n)
{
    unsigned char diy[2];
    diy[0] = 0xc1;
    diy[1] = 0x01;
